    ...
    <div class="perfil">
           ...
           //Crear la conexión a la base de datos y verificar la conexión
            try{$conn = mysqli_connect($host, $usuariobd, $contraseñabd, $bd, $puerto);}
                ...
                $error = "Error al conectarse a la base de datos en perfil.php: " . $error->getMessage();
                error_log($error);
            ...
            $sql = "SELECT fotoc,fotop FROM usuarios WHERE usuario = '{$_SESSION['usuario']}'";
            ...
            if (mysqli_num_rows($r) > 0) {
                while ($row = mysqli_fetch_assoc($r)) {
                    ...
                    echo '<div class="usuario"><h1>' . $_SESSION["usuario"] . '</h1></div>';
            ...
            if (isset($_POST['borrar'])) {
                ...
                if (!mysqli_query($conn, $sql)) {
                    echo "Error al eliminar el tweet: " . mysqli_error($conn);
                }
            }


            // Obtener y mostrar los textos e imágenes guardados en la base de datos
            $sql = "SELECT * FROM tweets WHERE creador = '{$_SESSION["usuario"]}' ORDER BY fecha DESC";
            $r = mysqli_query($conn, $sql);
            ...
            // Formulario para escribir comentarios secundarios
                ...
                echo '<textarea name="textoc" rows="1" maxlength="280" style="resize: none; width: 98%; height:50%;border: 1px solid black;" oninput="actualizarConteocomentario()"></textarea>';
                ...
                echo ' <input type="hidden" name="pagina" value="../perfil/perfil.php">';
                    ...
                    //Imprimir el archivo
                        ...
                        // Botón de eliminación 
                            if ($rowComentario['creador'] == $_SESSION['usuario']) {
                                ...
                                echo '<input type="image" src="../img/papelera.png" style="margin-bottom:5%;" width= 15px; value="Eliminar" title="Eliminar">';
                                echo '</form>';
                            }
